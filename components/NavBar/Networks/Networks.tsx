...
const Networks: FC = (props: Props) => {
  return (
    <div className="networks border-2 border-black font-semibold text-black transition-all dark:border-[#9A9E9E] dark:bg-[#31353F] dark:text-[#9A9E9E] dark:hover:bg-[#1B2028]">
      <div>
        <button className="flex w-full items-center bg-[#E6E4F6] pr-1 transition-all hover:bg-[#C6C2E7] dark:bg-[#31353F] dark:hover:bg-[#1B2028] dark:hover:text-white">
      ...
      <div>
        <button className="flex w-full items-center bg-black pr-1 text-white transition-all dark:bg-black dark:hover:text-white">
