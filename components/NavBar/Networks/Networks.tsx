...
const Networks: FC = (props: Props) => {
  return (
    <div className="networks dark:border-[#9A9E9E border-2 border-black font-semibold text-black transition-all dark:bg-[#31353F] dark:text-[#9A9E9E] dark:hover:bg-[#1B2028]">
      <div>
