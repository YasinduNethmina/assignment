    ...
    <>
      <div className="fixed top-0 left-0 z-50 w-full bg-transparent lg:hidden">
        <div className="h-screen w-3/4 bg-[#E6E4F6] p-5 dark:border-r-2 dark:border-[#9A9E9E] dark:bg-[#31353F]">
          ...
          <button className="shadow:xl absolute bottom-10 left-28 border-2 border-black p-2 dark:rounded-md dark:border-blue-600 dark:bg-blue-600 dark:font-bold dark:hover:border-blue-700 dark:hover:bg-blue-700 sm:left-48">
            CONNECT WALLET
          </button>
        </div>
      </div>
